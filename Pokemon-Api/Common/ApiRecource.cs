...
namespace Pokemon_Api.Common
{
    ...
    public class StructResource<T> : IResource<T>
    {
        ...
        public virtual async Task<T> GetObject() => throw new NotImplementedException();//await DataFetcher.GetAny<T>(Url);
    }
        ...
        where T : ApiObject
    {
        ...
        public virtual async Task<T> GetObject() => throw new NotImplementedException();//await DataFetcher.GetApiObject<T>(Url);
    }
